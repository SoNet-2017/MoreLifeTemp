...
angular.module('myApp.trendAttivi.trendAttivoListService', [])

    .factory('trendAttivoListService', function commonProp($firebaseArray, $firebaseObject) {

        var trendAttivoListService = {
